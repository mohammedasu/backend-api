...
class AudienceFilterHelper
{
    ...
    {
        Log::info('AudienceFilterHelper | universal3Filter');
        ...
        if (isset($universal_filters['main_city_selected']) && $universal_filters['main_city_selected'] != null && $universal_filters['main_city_selected'][0] != null) {
            $filter_data = $filter_data->whereIn('universal3.main_city', $universal_filters['main_city_selected']);
        }

        if (isset($universal_filters['metro_city_selected']) && $universal_filters['metro_city_selected'] != null && $universal_filters['metro_city_selected'][0] != null) {
            $filter_data = $filter_data->whereIn('universal3.metro_city', $universal_filters['metro_city_selected']);
        }
        ...
        if (isset($universal_filters['main_city_negative_selected']) && $universal_filters['main_city_negative_selected'] != null) {
            $filter_data = $filter_data->whereNotIn('universal3.main_city', $universal_filters['main_city_negative_selected']);
        }

        if (isset($universal_filters['metro_city_negative_selected']) && $universal_filters['metro_city_negative_selected'] != null) {
            $filter_data = $filter_data->whereNotIn('universal3.metro_city', $universal_filters['metro_city_negative_selected']);
        }
    ...
    public static function memberFilter($filter_data, $member_filters)
    {
        Log::info('AudienceFilterHelper | memberFilter', $member_filters);
        ...
        if (isset($member_filters) && $member_filters != null && ((isset($member_filters['answered_case']) && $member_filters['answered_case'] != null) || (isset($member_filters['video_watched']) && $member_filters['video_watched'] != null)
            ...
            $filter_data = $filter_data->join('members as M', 'M.member_ref_no', '=', 'universal3.member_ref_no');

            if ((isset($member_filters['answered_case']) && $member_filters['answered_case'] != null)) {
                $filter_data = $filter_data->join('case_members as CM', 'M.id', '=', 'CM.member_id');
            ...
            if ((isset($member_filters['video_watched']) && $member_filters['video_watched'] != null)) {
                ...
                $filter_data = $filter_data->join('member_video_histories as MVH', 'M.id', '=', 'MVH.member_id');
            ...
            if ((isset($member_filters['forum_subscription']) && $member_filters['forum_subscription'] != null)) {
                $filter_data = $filter_data->join('member_forum_subscriptions as MFS', 'M.id', '=', 'MFS.member_id');
            ...
            if ((isset($member_filters['member_is_prime']) && $member_filters['member_is_prime'] != null)) {
                $check_prime = filter_var($member_filters['member_is_prime'], FILTER_VALIDATE_BOOLEAN);
                if ($check_prime == 1) {
                    $filter_data = $filter_data->where('M.is_prime', 1);
                }
            }
        }
        return $filter_data;
    }
    public static function liveEventFilter($filter_data, $live_event_filters)
    {
        Log::info('AudienceFilterHelper | liveEventFilter');
    ...
    public static function audienceFilter($filter_data, $universal_filters, $member_filters, $live_event_filters)
    {
        Log::info('AudienceFilterHelper | Data Filter');
        $filter_data = self::universal3Filter($filter_data, $universal_filters);
        $filter_data = self::memberFilter($filter_data, $member_filters);
        $filter_data = self::liveEventFilter($filter_data, $live_event_filters);
        return $filter_data;
    }
}
