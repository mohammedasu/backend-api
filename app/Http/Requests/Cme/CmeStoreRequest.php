...
class CmeStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'type'                      => 'required',
            'name'                      => 'required|string|max:255|unique:cmes,name,NULL,id,deleted_at,NULL',
            ...
            'members_csv_file'          => 'required_if:allowed_members_from,csv|mimes:csv,txt|nullable|max:2048',
