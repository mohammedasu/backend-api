...
class NotificationUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'engagement_name'   => 'required|unique:engagements,engagement_name,' . $this->notification->id . ',id,deleted_at,NULL',
            ...
            'csv_file'          => 'sometimes|nullable|mimes:csv,txt|max:2048|nullable',
