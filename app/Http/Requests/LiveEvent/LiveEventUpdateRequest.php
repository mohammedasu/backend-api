...
class LiveEventUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'link_id' => 'required|string|max:255|unique:live_events,link_id,'. $this->live_event->id,
            "session_time" => "required",
            "buffer_time" => "required",
            "title" => "required",
            "partner_id" => "required|exists:partners,id",
            "video_id" => "required_if:video_event_type,0",
            ...
            "vchat_id" => "required_if:video_event_type,0",
