...
class AddColumnToMemberVideoHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('member_video_histories', function (Blueprint $table) {
            $table->dropColumn(['utm_source', 'utm_campaign', 'utm_medium', 'utm_id','ip_address','ip_country','ip_state','ip_city','device_name']);
        });
    }
}
